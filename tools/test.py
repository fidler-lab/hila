...
def main():
    ...
    outputs = single_gpu_test(model, data_loader, args.show, args.show_dir,
                              efficient_test, eval_f1_start=args.eval_f1_start,
                              eval_f1_step_size=args.eval_f1_step_size)
    ...
    if rank == 0:
        ...
        if args.eval:
            dataset.evaluate(outputs, args.eval, eval_f1=args.eval_f1_start, mod_f1=args.mod_f1,
                             eval_distance_crop=args.eval_distance_crop, **kwargs)
